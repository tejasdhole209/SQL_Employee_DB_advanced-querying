...
SELECT ED.EmployeeID, ED.Gender, AVG(ES.Salary) as AverageSalary FROM EmployeeDemographics AS ED LEFT OUTER JOIN EmployeeSalary AS ES
ON ED.EmployeeID=ES.EmployeeID
Group by ED.EmployeeID,ED.Gender
